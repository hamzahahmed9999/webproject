...
<head>
    ...
    <script>
        ...
        function signin()
        {
            ...
            var fb=firebase.auth();
            fb.signInWithEmailAndPassword(email, password).catch(function(error) {
                // Handle Errors here.
                var errorCode = error.code;
                var errorMessage = error.message;
                alert(errorMessage);
    ...
    <header id="header">
        <div class="container">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    <li><a href="signup.jsp" role="button" id="loginbtn" class="btn login">Signup</a></li>
                </ul>
        ...
        <div class="panel-body">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="form-group">
                    <button id="submitform" onclick="signin()" class="btn btn-primary">Login</button> </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form class="form" role="form" autocomplete="off" id="formLogin" novalidate="" method="POST">
                    ...
                    <div class="form-group py-4">
                        ...
                        <button type="submit" onclick="signin()" class="btn btn-success btn-lg float-right" id="btnLogin">Login</button>
                    </div>
                </form>
            </div>
        </div>
